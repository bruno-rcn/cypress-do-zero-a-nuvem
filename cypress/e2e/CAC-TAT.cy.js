describe('Central de Atendimento ao Cliente TAT', () => {
  ...
  it('Aula 7 Ex 1: Verifica que a política de privacidade abre em outra aba sem a necessidade de um clique', () => {
    cy.contains('a', 'Política de Privacidade').should('have.attr', 'href', 'privacy.html').and('have.attr', 'target', '_blank')
  });

  it('Aula 7 Ex 2: Acessa a página da política de privacidade removendo o target e então clicando no link', () => {
